...
import { DollarSign, Eye, CreditCard, Download, Search, Filter } from 'lucide-react';
...
const StudentFeesPage = () => {
  ...
  const classes = ['Grade 6A', 'Grade 6B', 'Grade 7A', 'Grade 7B', 'Grade 8A', 'Grade 8B', 'Grade 9A', 'Grade 9B', 'Grade 10A', 'Grade 10B'];
  ...
  const handlePayment = (studentId: number, amount: number) => {
    console.log(`Processing payment of ₹${amount} for student ${studentId}`);
    // Payment processing logic would go here
  };

  return (
    <DashboardLayout role="admin" title="Student Fee Management">
      <div className="space-y-6">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{students.filter(s => s.status === 'paid').length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-600">{students.filter(s => s.status === 'partial' || s.status === 'pending').length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">{students.filter(s => s.status === 'overdue').length}</p>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage fee payments for all students</CardDescription>
          </CardHeader>
          <CardContent>
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="max-w-2xl">
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  Complete fee information and payment history
                                </DialogDescription>
                              </DialogHeader>
                              ...
                              <div className="space-y-6">
                                ...
                                {student.dueAmount > 0 && (
                                  <div className="flex gap-2">
                                    <Button 
                                      onClick={() => handlePayment(student.id, student.dueAmount)}
                                      className="flex-1"
                                    >
                                      Record Payment
                                    </Button>
